...
In this first chapter, we'll set up our Laravel application and the models
we need to represent the posts, users, comments and tags that our blog
comprises of.
...
In this chapter we created our new Laravel application, and populated it with
the models that represent the data structure for our blog.

In the next chapter, we will add the JSON:API package and start to create our
JSON:API compliant backend server.
